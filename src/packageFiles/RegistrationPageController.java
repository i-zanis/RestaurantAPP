...
public class RegistrationPageController implements Initializable {
    ...
    public void registrationSuccessful(ActionEvent event) throws Exception {
        ...
        try {
            errorLabelRegistration.setText(createUser(nameRegistrationField.getText(), surnameRegistrationField.getText(),
                    ...
                    passwordFieldRegistration1.getText(),addressRegistrationField.getText(),postCodeRegistrationField.getText()));
    ...
    else if (errorLabelRegistration.getText().equals("Address is required.")) {
                addressRegistrationField.setText("");
                addressRegistrationField.requestFocus();
            }
    else if (errorLabelRegistration.getText().equals("Post Code is required.")) {
                postCodeRegistrationField.setText("");
                postCodeRegistrationField.requestFocus();
            }
